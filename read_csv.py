...
df_2015.columns = ['Ward', 'Division', 'Type', 'Office', 'Candidate', 'Party', 'Vote', '7', '8']
...
office_df.to_csv('office.csv')
party_df.to_csv('party.csv')
candidate_df.to_csv('candidate.csv')
